...
const socket = (window as any).io('wss://streamer.cryptocompare.com');
...
export function subscribeOnStream(
	...
	const channelString = `0~${(parsedSymbol as any).exchange}~${(parsedSymbol as any).fromSymbol}~${(parsedSymbol as any).toSymbol}`;
	const handler = {
		id: subscriberUID,
